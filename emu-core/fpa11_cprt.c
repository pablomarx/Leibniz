...
static unsigned int PerformComparison(const unsigned int opcode)
{
  ...
  FPA_Debug("PerformComparison(0x%08x)\n",opcode);
   ...
   {
     FPA_Debug("Fm = r%d which contains a ",Fm);
