...
enum {
  ...
  RuntInterruptUnknown0         = (1 << 3), // Notepad 1.0b1: RegisterInterrupt(0x8, 0x0, 0x74344); -- tablet?
  ...
  RuntInterruptUnknown4         = (1 << 18), // FIQ - Notepad 1.0b1: RegisterInterrupt(0x40000, 0x0, 0x74790); -- looks at ticks??
